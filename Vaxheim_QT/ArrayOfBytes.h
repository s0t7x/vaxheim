...
inline char* aobCompare(const char* pattern, const char* mask, char* begin, size_t size)
{
...
inline uintptr_t aobScan(HANDLE hProc, const char* pattern, const char* mask, char* begin, size_t size)
{
	char* match{ nullptr };
	SIZE_T bytesRead;
	DWORD oldprotect;
